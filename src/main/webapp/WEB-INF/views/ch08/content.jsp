...
<div class="card m-2">
	...
	<div class="card-body">
		<div class="card">
			...
			<script>
				function saveData() {
				//method 명시 안하면 디폴트가 GET방식이다.
					$.ajax({
						url: "saveData",
						data: {name:"홍길동"}
					})
					.done((data) => { // {result:"success"}를 받는다고 하자.
						console.log(data);
					});
				}
			...
			<div class="card-body">
				...
				<script>
					function login() {
						...
						$.ajax({
							url: "loginAjax",
							data: {mid, mpassword}, //{mid: mid, mpassword: mpassword}를 생략한거임
							method: "post"
						}).done((data) => {
							//data = {result:"success"}
