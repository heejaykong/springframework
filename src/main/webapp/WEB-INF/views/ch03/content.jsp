...
<div class="card m-2">
   ...
   <div class="card-body">
      ...
      <div class="card m-2">
         ...
         <script>
            function requestGet() {
               const param1 = document.form1.param1.value; // form 태그의 name으로 접근
               const param2 = document.querySelector("#param2").value;
               const param3 = $("#param3").val(); // jQuery 객체라 .val해줘야 함
               ...
               $.ajax({
                  ...
                  method:"get",
                  data: {
                     param1:param1, //이렇게 해도 되고
                     param2,        // 이렇게 해도 됨(key: value이름이 같은 경우엔)
                     param3, 
                     param4, 
                     param5
                  }
               })
               .done(() => {}); // 성공적인 응답 시 콜백될 함수 정의
            }
